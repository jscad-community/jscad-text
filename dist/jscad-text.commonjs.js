...
var require$$0$1 = require('@jscad/modeling');
...
var hasRequiredTextToPaths;

function requireTextToPaths () {
	if (hasRequiredTextToPaths) return textToPaths;
	hasRequiredTextToPaths = 1;
	Object.defineProperty(textToPaths, "__esModule", { value: true });
	textToPaths.textToPaths = void 0;
	const modeling_1 = require$$0$1;
	const SVGpxPmm = 1 / 0.2822222; // used for scaling SVG coordinates(PX) to JSCAD coordinates(MM)
	const textToPaths$1 = ({ font, fontSize = 14, xOffset = 0, yOffset = 0, // position of the baseline
	fontKerning = true, fontHinting = true, segments = 32, // for interpretation to JSCAD paths
	pxPmm = SVGpxPmm, // for interpretation to JSCAD paths
	 }, text) => {
	    if (!font)
	        throw new Error("font is a required option");
	    let pathoptions = {
	        kerning: fontKerning,
	        hinting: fontHinting,
	    ...
	    if (fontpath.stroke) {
	        pathcolor = modeling_1.colors.colorNameToRgb(fontpath.stroke);
	    }
	    else {
	        if (fontpath.fill) {
	            pathcolor = modeling_1.colors.colorNameToRgb(fontpath.fill);
	        }
	    }
	    let paths = interpretCommands({ pathcolor, segments, pxPmm }, fontpath.commands);
	    return paths;
	};
	textToPaths.textToPaths = textToPaths$1;
	const interpretCommands = ({ pathcolor, segments, pxPmm }, commands) => {
	    ...
	    for (let j = 0; j < commands.length; j++) {
	        ...
	        switch (command.type) {
	            case "M": // absolute move to
	                if (path) {
	                    path = modeling_1.geometries.path2.close(path);
	                    if (pathcolor)
	                        modeling_1.colors.colorize(pathcolor, path);
	                    paths.push(path);
	                }
	                cx = command.x;
	                cy = command.y;
	                path = modeling_1.geometries.path2.fromPoints({}, [
	            ...
	            case "L": // absolute line to
	                if (cx !== command.x || cy !== command.y) {
	                    ...
	                    cy = command.y;
	                    if (path) {
	                        path = modeling_1.geometries.path2.appendPoints([[convX(cx, pxPmm), convY(cy, pxPmm)]], path);
	                    }
	                }
	                break;
	            case "C": // absolute cubic Bezier
	                ...
	                cy = command.y;
	                if (path) {
	                    path = modeling_1.geometries.path2.appendBezier({
	                        controlPoints: [
...
var opentype_module = /*#__PURE__*/Object.freeze({
	__proto__: null,
	BoundingBox: BoundingBox,
	Font: Font,
	Glyph: Glyph,
...
var hasRequiredLoadFont;

function requireLoadFont () {
	if (hasRequiredLoadFont) return loadFont;
	hasRequiredLoadFont = 1;
	var __importDefault = (loadFont && loadFont.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(loadFont, "__esModule", { value: true });
	loadFont.loadFontFromData = loadFont.loadFont = loadFont.loadFontAsync = void 0;
	const opentype_js_1 = __importDefault(require$$0);
	...
	loadFont.loadFontAsync = loadFontAsync;
	/**
	 ...
	 */
	const loadFont$1 = (url) => {
	    return opentype_js_1.default.loadSync(url);
	};
	loadFont.loadFont = loadFont$1;
	/**
	...
	loadFont.loadFontFromData = loadFontFromData;
	return loadFont;
}
...
function requireSrc () {
	...
	(function (exports) {
		...
		exports.loadFontFromData = exports.loadFontAsync = exports.loadFont = exports.textToPaths = void 0;
		const textToPaths_1 = requireTextToPaths();
		Object.defineProperty(exports, "textToPaths", { enumerable: true, get: function () { return textToPaths_1.textToPaths; } });
		const loadFont_1 = requireLoadFont();
